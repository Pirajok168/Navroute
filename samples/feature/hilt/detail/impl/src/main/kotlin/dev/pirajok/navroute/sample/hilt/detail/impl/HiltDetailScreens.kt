package dev.pirajok.navroute.sample.hilt.detail.impl
...
import dev.pirajok.navroute.sample.hilt.detail.api.HiltDetailSheetRoute
import dev.pirajok.navroute.sample.hilt.detail.api.HiltNestedDetailSheetRoute
...
@NavEntry(
    route = HiltDetailRoute::class,
    style = DestinationStyle.Screen::class,
)
@Composable
public fun HiltDetailScreen(itemId: Int, title: String) {
...
@NavEntry(
    route = HiltDetailSheetRoute::class,
    style = HiltDetailSheetStyle::class,
)
@Composable
public fun HiltDetailSheet(itemId: Int, title: String) {
    val navigator = rememberSampleNavigator()
    ...
    Column(
        ...
        Button(
            ...
            onClick = { navigator.navigate(HiltNestedDetailSheetRoute(itemId = itemId)) },
        ) {
...
@NavEntry(
    route = HiltNestedDetailSheetRoute::class,
    style = HiltNestedDetailSheetStyle::class,
)
@Composable
public fun HiltNestedDetailSheet(itemId: Int) {
    val navigator = rememberSampleNavigator()
...
public object HiltDetailSheetStyle : BottomSheetDestinationStyle() {
    override val keepWhenOverlaid: Boolean = true
}

public object HiltNestedDetailSheetStyle : BottomSheetDestinationStyle()
