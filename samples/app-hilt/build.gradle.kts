...
android {
    namespace = "dev.pirajok.navroute"
    compileSdk {
        version = release(37) {
            minorApiLevel = 0
        }
    ...
    defaultConfig {
        applicationId = "dev.pirajok.navroute"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation(project(":samples:feature:hilt:main:impl"))
    implementation(project(":samples:feature:hilt:detail:api"))
    implementation(project(":samples:feature:hilt:detail:impl"))
